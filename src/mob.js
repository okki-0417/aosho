  ...
  update() {
    if (this.sign == 0) {
      if (
        ...
        playerOnMobCheckHit("left", this, jiki) &&
        screenHit("left", this)
      ) {
        this.x -= this.speed;
      ...
      if (
        ...
        playerOnMobCheckHit("right", jiki, this) &&
      ...
      if (
        ...
        playerOnMobCheckHit("up", jiki, this) &&
        screenHit("up", this)
      ) {
        this.y -= this.speed;
      ...
      if (
        ...
        playerOnMobCheckHit("down", jiki, this) &&
        screenHit("down", this)
      ) {
        this.y += this.speed;
        this.foot_y += this.speed;
      ...
      //静止時は向いている方向で正立姿勢に戻す
      if (this.snum == this.snumL - 1 || this.snum == this.snumL + 1)
        this.snum = this.snumL;
      if (this.snum == this.snumR - 1 || this.snum == this.snumR + 1)
        this.snum = this.snumR;
      if (this.snum == this.snumU - 1 || this.snum == this.snumU + 1)
        this.snum = this.snumU;
      if (this.snum == this.snumD - 1 || this.snum == this.snumD + 1)
        this.snum = this.snumD;
